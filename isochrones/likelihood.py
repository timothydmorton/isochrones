from isochrones.mags import interp_mag, interp_mag_4d
...
def star_lnlike_4d(
    ...
    has_triple = False
    if n_pars == 6:
        single_pars = [pars[0], pars[1], pars[2], pars[3], pars[4], pars[5]]
    elif n_pars == 7:  # binary system
        single_pars = [pars[0], pars[2], pars[3], pars[4], pars[5], pars[6]]
        binary_pars = [pars[1], pars[2], pars[3], pars[4], pars[5], pars[6]]
        has_binary = True
    elif n_pars == 8:  # triple system
        single_pars = [pars[0], pars[3], pars[4], pars[5], pars[6], pars[7]]
        binary_pars = [pars[1], pars[3], pars[4], pars[5], pars[6], pars[7]]
        triple_pars = [pars[2], pars[3], pars[4], pars[5], pars[6], pars[7]]
        has_binary = True
        has_triple = True

    Teff, logg, feh, mags = interp_mag_4d(
        single_pars,
        index_order,
        model_grid,
        i_Teff,
    ...
    if has_binary:
        _, _, _, mags_binary = interp_mag_4d(
            binary_pars,
            index_order,
            model_grid,
            i_Teff,
    ...
    if has_triple:
        _, _, _, mags_triple = interp_mag_4d(
            triple_pars,
            index_order,
            model_grid,
            i_Teff,
